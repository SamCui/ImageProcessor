...
{
    public class DotnetImageTransformer: IGrayscaleTransformer
    {
 
        public DotnetImageTransformer()
        {
        ...
        public void ConvertToGrayScale(string SourceFileName, string DestFileName)
        {
            ...
            FileSaver.TargetFileName = DestFileName;
            FileSaver.SaveImages(bitMaps, DestFileName);
        }
